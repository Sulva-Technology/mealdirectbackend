...
| Paystack webhook security  | CONDITIONAL PASS | Paystack endpoint verifies HMAC signature and duplicate deliveries in tests                                                | Persist webhook idempotency/effects in PostgreSQL               | Backend    | Critical |
